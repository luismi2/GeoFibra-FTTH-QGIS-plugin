...
<qgis version="2.18.10" simplifyAlgorithm="0" minimumScale="500" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="'CPD'"/>
