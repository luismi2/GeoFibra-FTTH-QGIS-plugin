...
<qgis version="2.18.15" simplifyAlgorithm="0" minimumScale="1" maximumScale="3000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{b9e2dd08-36b3-4a54-8dff-eca74d178c71}">
      <rule key="{790dc705-c939-47d1-850e-7e04a4326889}" symbol="0">
        <rule scalemaxdenom="1000" key="{2a3d2d14-7e5b-4609-82a2-005078ca2ad9}" symbol="1" scalemindenom="1" label="0 - 1000"/>
        <rule scalemaxdenom="1000000" key="{2c82001a-7e71-4a5b-aaec-2101fe02a00d}" symbol="2" scalemindenom="1000" label="1000 - 0"/>
      </rule>
    </rules>
    <symbols>
